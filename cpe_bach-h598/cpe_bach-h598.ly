...
% line 10
b8^\trill a r4 | R2 | cis,8_\f c4 dis8 | e4. g8 |
e^\trill dis8 r4 | e4 g16 fis e dis |
% line 11
dis4( e8) r8 | g4 b16 a g fis | fis4( g16) b a c | b8 fis16 g b a g fis |
fis4( g16) b a c |
% line 12
b8 fis 16 g b a g fis | g16 e fis g a b cis dis | \ficta dis8( e4) ais,8 |
...
\stemUp d,8 \stemNeutral d'16 c? b a \bar ":..:" |
